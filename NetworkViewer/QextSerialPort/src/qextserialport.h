...
class QEXTSERIALPORT_EXPORT QextSerialPort: public QIODevice
{
    ...
    public:
		...
		QextSerialPort(QObject *parent = NULL);
        QextSerialPort(QueryMode mode, QObject *parent = NULL);
        QextSerialPort(const QString & name, QueryMode mode = EventDriven, QObject *parent = NULL);
        QextSerialPort(QextPortSettings const& s, QueryMode mode = EventDriven,
            QObject *parent = NULL);
        QextSerialPort(const QString & name, QextPortSettings const& s,
            QueryMode mode = EventDriven, QObject *parent = NULL);
        ~QextSerialPort();
        ...
        void setPortSettings(const QextPortSettings &settings);
        QextPortSettings portSettings() const;
