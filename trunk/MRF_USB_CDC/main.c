...
#elif defined(PIC18F24J50_PIM)			// Configuration bits for PIC18F24J50 MRF-USB Module
...
char *dataptr = &RS232_Out_Data;			//MOD
...
static void InitializeSystem(void)
{
	UCFGbits.UPUEN = 1;	//Active les pull-up interne (tentative...)	
    ...
    #if defined(PIC18F87J50_PIM) || defined(PIC18F46J50_PIM) || defined(PIC18F47J53_PIM) || defined(PIC18F24J50_PIM)
    ...
    #if defined(PIC18F46J50_PIM) || defined(PIC18F47J53_PIM) || defined(PIC18F24J50_PIM)
	//Configure all I/O pins to use digital input buffers.  The PIC18F87J50 Family devices
	//use the ANCONx registers to control this, which is different from other devices which
	//use the ADCON1 register for this purpose.
    ANCON0 = 0xFF;                  // Default all pins to digital
    ...
    #if defined(PIC18F24J50_PIM) || defined(PIC18F47J53_PIM) || defined(PIC18F24J50_PIM)
	//Configure all I/O pins to use digital input buffers.  The PIC18F87J50 Family devices
	//use the ANCONx registers to control this, which is different from other devices which
	//use the ADCON1 register for this purpose.
    ANCON0 = 0xFF;                  // Default all pins to digital
