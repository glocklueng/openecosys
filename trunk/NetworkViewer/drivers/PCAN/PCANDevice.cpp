...
static bool PCAN_DEVICE_INIT = CANDevice::registerDeviceFactory("PCANDevice",new CANDevice::DeviceFactory<PCANDevice>("/dev/pcan32","Arguments for Linux only."));
