...
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
                Posix_CommConfig.c_cflag|=500000;
#else
                cfsetispeed(&Posix_CommConfig, 500000);
                cfsetospeed(&Posix_CommConfig, 500000);
#endif
                break;
...
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
                Posix_CommConfig.c_cflag|=1000000;
#else
                cfsetispeed(&Posix_CommConfig, 1000000);
                cfsetospeed(&Posix_CommConfig, 1000000);
#endif
                break;
